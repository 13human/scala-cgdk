...
class Move {
    /**
     * Текущая установка режима работы двигателя кодемобиля.
     * <p/>
     ...
     */
    var enginePower: Double = .0

    /**
     * Текущее положение педали тормоза.
     * <p/>
    ...
    /**
     * Текущий относительный угол поворота колёс кодемобиля.
     * <p/>
     ...
     */
    var wheelTurn: Double = .0

    /**
     * Текущее значение указания метнуть снаряд.
     * <p/>
     ...
     */
    var throwProjectile: Boolean = false

    /**
     * Текущее значение указания использовать <<нитро>>.
     * <p/>
     ...
     */
    var useNitro: Boolean = false

    /**
     * Текущее значение указания разлить канистру с мазутом.
     * <p/>
